...
    try {
      // CORREGIDO: URL DE RAILWAY
      const respuesta = await fetch("https://[TU-DOMINIO-DE-RAILWAY].up.railway.app/api/usuarios/login", {
        method: "POST",
...
    try {
      // CORREGIDO: URL DE RAILWAY
      const respuesta = await fetch("https://[TU-DOMINIO-DE-RAILWAY].up.railway.app/api/usuarios", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
  try {
    // CORREGIDO: URL DE RAILWAY
    const respuesta = await fetch(`https://[TU-DOMINIO-DE-RAILWAY].up.railway.app/api/usuarios/${id}`, { 
  method: "DELETE"
    });
